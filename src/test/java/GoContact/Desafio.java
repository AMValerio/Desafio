...
public class Desafio {
	...
	public void tc1_AlreadyUser() throws InterruptedException{
		...
		System.out.println("TC01" + " Validar cenário de Criar conta nova: Criar conta nova com user já existente => validar que o site não permite");
		...
		/*Dados de teste:
		 * email: amevaleriotest@gmail.com
		 * pass: Amazon.1
		 */
	...
	public void tc5_1avengers() throws InterruptedException{
		...
		WebElement element = driver.findElement(By.xpath("//*[@id=\"search\"]/div[1]/div[2]/div/span[3]/div[1]/div[2]"));
	...
	public void tc5_2avengers() throws InterruptedException{
		...
		WebElement element = driver.findElement(By.className("//*[@id=\"a-page\"]/div[3]/div[2]/div/div/div[2]/div[3]/div/div[2]"));
